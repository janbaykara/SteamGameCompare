			...
			success: function(data) {
				...
				for (i = 0; i < (json.length); ++i) {
					...
					$.each( json[i].gameXMLData, function(n, game) {
						...
						var backgroundCSS = "url('";
						backgroundCSS += "http://cdn4.steampowered.com/v/gfx/apps/"+thisGame[1]+"/header.jpg"
						backgroundCSS += "') 50% 50%";
						
						var thisLI = $('<li>');
						thisLI.css("background",backgroundCSS);
						thisLI.addClass("prettyGame");
				...
				$(document).ready(function() {
					...
					$("#display_games li.same").hover(
						function() {
							...
							/*
							var backgroundCSS = "url('";
							backgroundCSS += "http://cdn4.steampowered.com/v/gfx/apps/"+$(this).attr('appid')+"/header_292x136.jpg"
							backgroundCSS += "') 50% 50%";
							
							$(this).css("background",backgroundCSS);
							$(this).toggleClass("prettyGame");
							*/
